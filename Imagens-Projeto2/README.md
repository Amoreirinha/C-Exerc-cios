...
### Funções auxiliares 
O código está separado em duas partes o `main.cpp`e o `functions.h`, em que no functions.h, é armazenada as funções que serão chamadas no main.cpp, como:
