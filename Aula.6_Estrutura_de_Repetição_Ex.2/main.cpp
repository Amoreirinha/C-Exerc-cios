 ...
 *
 * Created on 27 de março de 2025, 08:36
 */
 ...
 * }
 * 
 * Exemplo: Calcular a média de alturas de um grupo de n pessoas.
 * 
 * Obs:
...
int main(int argc, char** argv) {
    ...
    while(soma=!0){
        printf("\nDigite a quantidade de pessoas desse grupo:\n");
    ...
    printf("\nA média de alturas desse grupo de %d pessoas é %.2fm",quantpessoas, media);
